"""
Lith_main.py – Analizador Litológico de Patrones (Motor Calibrado Final)
=======================================================================
Resuelve los empates exactos (Dolomita, Arenisca Calcárea, Arcilita Tobácea)
mediante discriminación de signos y reglas de afinidad litológica.
...
def _combined_image_score(patch_bgr, target_bgr):
    ...
    # 2. Histogramas en 6 canales (BGR + HSV)[cite: 1]
    score_hist = 0.0
    for src, dst in (
    ...
    # 3. Correlación Cruzada Normalizada (NCC)[cite: 1]
    ...
    # 4. Bordes con Laplaciano[cite: 1]
    ...
    return (score_color * 0.35) + (score_hist * 0.25) + (score_struct * 0.20) + (score_edges * 0.20)[cite: 1]
    ...
    def _process(self):
        ...
        for i, seg in enumerate(segments):
            ...
            for cat_item in catalog:
                ...
                # 4. Caliza Arcillosa (idLith 38) -> 17.png sobre 15.png / 5-2.png
