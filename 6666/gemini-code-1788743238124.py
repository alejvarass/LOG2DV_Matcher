"""
Lith_main.py – Analizador Litológico de Patrones (Alineación Cromática y Visual Continua)
========================================================================================
Corrige las anulaciones a 0.0% y los falsos "Sin coincidencia".
Alinea brillo/contraste en espacio LAB entre escaneos y patrones digitales.
Sin cortes destructivos. Multihilo PySide6.
"""
...
# ---------------------------------------------------------------------------
# Comparación Multi-Métrica sin Cortes Abruptos
# ---------------------------------------------------------------------------
def _combined_image_score(patch_bgr, target_bgr):
    ...
    # 1. Color LAB: cálculo continuo sin cortes a 0.0
    ...
    # Escala continua: disminuye progresivamente con la distancia cromática
    score_color = max(0.0, 100.0 - mean_diff * 1.2)
    ...
    # Balance: 35% Color, 25% Histogramas, 20% Estructura, 20% Bordes[cite: 1]
...
class ProcessingWorker(QThread):
    ...
    def _process(self):
        ...
        self.stage_changed.emit("Etapa 4: Comparación Multi-Métrica Continua e IA")
        ...
        for i, seg in enumerate(segments):
            ...
            for cat_item in catalog:
                ...
                # Fusión continua: 75% visión clásica multiescala + 25% DINOv2
